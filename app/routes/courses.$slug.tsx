            ...
            <div className="course-main-column">
              ...
              <div className="course-content-block">
                <h2 className="block-title">
                  <BookOpen size={22} color="#0066FF" /> Program Overview
                </h2>
              ...
              <div className="course-content-block">
                <h2 className="block-title">
                  <FileText size={22} color="#0066FF" /> Key Curriculum &amp; Core Modules
                </h2>
              ...
              <div className="course-content-block">
                <h2 className="block-title">
                  <ShieldCheck size={22} color="#0066FF" /> Admission &amp; Entry Requirements
                </h2>
                <div className="requirements-box">
                  <ul className="requirements-list">
                    {course.entryRequirements.map((req, idx) => (
                      <li key={idx} className="requirement-item">
                        <CheckCircle2 size={16} color="#0066FF" className="req-icon" />
                        <span>{req}</span>
                      </li>
                    ))}
                  </ul>
              ...
              <div className="course-content-block">
                <h2 className="block-title">
                  <TrendingUp size={22} color="#0066FF" /> Career Opportunities &amp; Graduate Roles
                </h2>
                <p className="block-text">
              ...
              <div className="course-content-block">
                <h2 className="block-title">
                  <Building2 size={22} color="#0066FF" /> Top Panel Universities Offering This Course
                </h2>
