    ...
    <div>
      ...
      <section className="dest-all-hero-banner">
        <div className="container">
          <div className="badge badge-gold" style={{ display: "inline-flex", alignItems: "center", gap: "6px", marginBottom: "14px" }}>
            <Globe2 size={15} /> Global Study Destinations
          </div>
          <h1 className="dest-all-hero-title">Choose Your Ideal Study Abroad Country</h1>
          <p className="dest-all-hero-subtitle">
            Explore 12+ premier international education destinations, post-study work rights, visa acceptance rates, and our 450+ partner university network.
          </p>
                  ...
                  <div className="dest-catalog-body">
                    ...
                    <div className="dest-catalog-uni-preview">
                      <div className="preview-label">
                        <GraduationCap size={14} color="#0066FF" />
